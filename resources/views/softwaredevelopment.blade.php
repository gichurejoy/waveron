...
<div class="container py-5">
    <div class="row justify-content-center mb-5">
        <div class="col-lg-8 text-center">
            <h2 class="section-title mb-4" style="color: var(--primary-color)">Technologies We Use</h2>
            <p class="lead mb-5" style="color: var(--secondary-color)">We leverage cutting-edge technologies and frameworks to build powerful, scalable, and future-proof solutions that drive your business forward.</p>
        </div>
    </div>
    <div class="row g-4">
