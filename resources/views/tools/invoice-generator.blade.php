                ...
                <div class="card border-0 shadow-sm rounded-4 p-4 mb-4">
                    ...
                    <div class="row g-3 mb-4">
                        ...
                        <div class="col-12">
                            ...
                            <input type="file" id="biz-logo" class="form-control form-control-sm" accept="image/*">
                            <div class="form-text small text-muted">Upload a company logo to display on the invoice.</div>
                        </div>
                    </div>
            ...
            <div class="col-lg-6">
                <div class="preview-sticky">
                    ...
                    <div id="invoice-preview" class="invoice-paper shadow-sm bg-white p-5 rounded-3">
                        ...
                        <!-- Watermark -->
                        <div class="pt-3 mt-4 border-top text-end watermark-print" style="border-top: 1px dashed #e5e7eb !important;">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    bizLogoInput.addEventListener('change', function(e) {
